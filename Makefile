...
src = src/Crew.c src/Player.c src/Texture.c src/Shaders.c src/Stage.c src/Utils.c src/main.c src/Persist.c src/Text.c src/Lua.c src/Renderer.c src/Actors.c
